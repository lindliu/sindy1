...
from utils import basis_functions_mix0_3d, basis_functions_mix1_3d, basis_functions_mix2_3d, \
                ...
                basis_functions_mix1_3d_, basis_functions_mix2_3d_, basis_functions_name_mix1_3d_, basis_functions_name_mix2_3d_
np.random.seed(42)
...
def get_basis_functions(basis_type, GSINDY=True):
    if GSINDY:
        if basis_type == 'mix_diff':
            basis_functions_list = [basis_functions_mix0_3d, basis_functions_mix1_3d_, basis_functions_mix2_3d_]          ### basis functions for each feature
            basis_functions_name_list = [np.array([f(1,1,1) for f in basis_functions_name_mix0_3d]), \
                                         np.array([f(1,1,1) for f in basis_functions_name_mix1_3d_]), \
                                         np.array([f(1,1,1) for f in basis_functions_name_mix2_3d_])]     ### corresponding names of the basis functions
