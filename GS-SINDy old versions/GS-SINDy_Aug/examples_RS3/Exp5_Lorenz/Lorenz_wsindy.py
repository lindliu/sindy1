...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  8 19:29:52 2024
...
for i in range(6):
    ...
    model_set = []
    for threshold_sindy in [0.005, 0.01, 0.05, 0.1, 0.5, 1, 5, 10]:
    
        # Instantiate and fit the SINDy model with the integral of u_dot
        opt = ps.SR3(
        threshold=threshold_sindy, thresholder="l1", max_iter=10000, normalize_columns=True, tol=1e-10
        )
    ...
    ms, best_BIC_model = model_selection_coeff_3d(model_set, u_train, x0, t_train, a, real_list, basis)
