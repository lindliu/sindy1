...
ax[0,0].hist([-.1,-.05,0,.05,.1], weights=[5,30,60,4,1], alpha = 0.5, color='c', rwidth=0.4)
ax[0,0].hist([-.2,-.15,-.1,0,.08,.1,.15,.2], weights=[5,10,20,15,7,10,22,11], alpha = 0.5, color='orange', rwidth=0.2)
ax[0,0].hist([-.03,-.01,0,.02], weights=[10,40,45,5], alpha = 0.5, color='r', rwidth=1)
ax[0,0].set_xlim(-.3,.3)
ax[0,0].set_xticks(ticks=[-.3,.3])
ax[0,0].set_yticks(ticks=[20,40,60])
ax[0,0].set_xlabel(r'$1$', size=18)

ax[0,1].hist([.6,.63,.66,.68,.7,.73,.75,1], weights=[5,10,4,20,31,20,7,3], alpha = 0.5, color='c', rwidth=0.2)
ax[0,1].hist([.9,.95,.99,1.05,1.1,1.3], weights=[3,37,48,2,3,7], alpha = 0.5, color='orange', rwidth=0.3)
ax[0,1].hist([.48,.5,.52,.53], weights=[30,33,24,13], alpha = 0.5, color='r', rwidth=1)
ax[0,1].set_xlim(.3,1.4)
ax[0,1].set_xticks(ticks=[.3,1.4])
ax[0,1].set_yticks(ticks=[20,40,60])
ax[0,1].set_xlabel(r'$x$', size=18)

ax[0,2].hist([-.05,-.01,0,.03,.05], weights=[3,25,63,4,5], alpha = 0.5, color='c', rwidth=0.5)
ax[0,2].hist([-.03,-.02,0,.01,.02], weights=[8,27,55,7,3], alpha = 0.5, color='orange', rwidth=0.5)
ax[0,2].hist([-.04,.02,.04], weights=[22,58,20], alpha = 0.5, color='r', rwidth=1)
ax[0,2].set_xlim(-.3,.3)
ax[0,2].set_xticks(ticks=[-.3,.3])
ax[0,2].set_yticks(ticks=[20,40,60])
ax[0,2].set_xlabel(r'$y$', size=18)

ax[1,0].hist([-.05,-.01,0,.03,.05], weights=[3,63,4,5,25], alpha = 0.5, color='c', rwidth=0.5)
ax[1,0].hist([-.03,-.02,0,.01,.02], weights=[55,8,27,7,3], alpha = 0.5, color='orange', rwidth=0.5)
ax[1,0].hist([-.04,0,.02,.04], weights=[3,40,50,7], alpha = 0.5, color='r', rwidth=1)
ax[1,0].set_xlim(-.3,.3)
ax[1,0].set_xticks(ticks=[-.3,.3])
ax[1,0].set_yticks(ticks=[20,40,60])
ax[1,0].set_xlabel(r'$x^2$', size=18)

ax[1,1].hist([-.85,-.82,-.8,-.77], weights=[8,63,24,5], alpha = 0.5, color='c', rwidth=1)
ax[1,1].hist([-1.2,-1.05,-1.,-.96], weights=[5,55,30,10], alpha = 0.5, color='orange', rwidth=.5)
ax[1,1].hist([-.63,-.6,-.57], weights=[30,64,6], alpha = 0.5, color='r', rwidth=1)
ax[1,1].set_xlim(-1.3,-.4)
ax[1,1].set_xticks(ticks=[-1.3,-.4])
ax[1,1].set_yticks(ticks=[20,40,60])
ax[1,1].set_xlabel(r'$xy$', size=18)

ax[1,2].hist([-.05,-.01,0,.03,.05], weights=[3,4,35,25,33], alpha = 0.5, color='c', rwidth=0.5)
ax[1,2].hist([-.03,-.02,0,.01,.02], weights=[27,12,45,13,3], alpha = 0.5, color='orange', rwidth=0.5)
ax[1,2].hist([-.04,0,.02,.04], weights=[21,36,36,7], alpha = 0.5, color='r', rwidth=1)
ax[1,2].set_xlim(-.3,.3)
